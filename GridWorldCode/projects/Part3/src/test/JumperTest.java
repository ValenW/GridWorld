...
public class JumperTest {
    ...
    public void testJump() {
        ...
        assertEquals(f, w.getGrid().get(new Location(1, 6)));
        assertEquals(a.getDirection(), Location.EAST);
    ...
    public void testJumpToOutside() {
        ...
        assertEquals(Location.WEST + Location.RIGHT, a.getDirection());
    }
    ...
    public void testJumpToActor() {
        ...
        a.moveTo(new Location(1, 5));
        x.moveTo(new Location(1, 7));
        oldHp = a.getHp();
        a.act();
        assertEquals(a.getLocation(), new Location(1, 7));
        assertEquals(a.getDirection(), Location.EAST);
        ...
        w.add(new Location(3, 7), b);
        oldHp = b.getHp();
        a.act();
        assertEquals(a, w.getGrid().get(new Location(3, 7)));
        assertEquals(b, w.getGrid().get(new Location(3, 8)));
